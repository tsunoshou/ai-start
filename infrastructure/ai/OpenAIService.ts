...
export class OpenAIService implements AIService {
   ...
   */
  async chat(messages: AIMessage[], options: AIConversationOptions): Promise<AIConversationResponse> {
   ...
   * @param tier 必要なモデル階層
   */
  async selectOptimalModel(messages: AIMessage[], tier: AIModelTier = AIModelTier.STANDARD): Promise<string> {
