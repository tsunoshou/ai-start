...
| `infrastructure/mappers/utils/mapping-helpers.ts`                    | `packages/shared/base/infrastructure/utils/mapping-helpers.ts`                            | マッピングヘルパー関数。基盤インフラのユーティリティとして `shared/base` 配下へ。                                                                                                                                              |
